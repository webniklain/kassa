...
function calculateMonthlySummary(
  ...
  // Дневная рекомендация строится из полного доступного финансового результата:
  // бюджет + приходы - все расходы + компенсируемые расходы
  // - только НЕИЗРАСХОДОВАННЫЙ остаток обязательных резервов.
  // Записываем формулу явно, а не через balance, чтобы приход месяца
  // никогда не потерялся при дальнейших изменениях логики.
